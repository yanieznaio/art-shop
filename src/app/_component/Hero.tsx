...
const Hero = () => {
    return (
        ...
        <div className='relative pt-40 text-whitegrey min-h-screen md:min-h-[120vh]'>
            <div className='absolute top-0 left-0 uppercase  w-full h-full bg-no-repeat bg-cover bg-top z-0 brightness-75' style={{ backgroundImage: "url('/gorgeous-woman-with-white-hair-stands-large-chair.jpg')" }} />
